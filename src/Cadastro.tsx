      ...
      <div className="container">
        ...
        <div className="container-cadastro">
          ...
          <form onSubmit={trataForm}>
            ...
            <input type="text" name="marca" id="marca" placeholder="Marca" onChange={trataMarca} />
            <input type="number" name="preco" id="preco" placeholder="Preço" onChange={trataPreco} />
            <input type="text" name="cor" id="cor" placeholder="Cor" onChange={trataCor} />
            <input type="text" name="categoria" id="categoria" placeholder="Categoria" onChange={trataCategoria} />
            <input type="number" name="ano" id="ano" placeholder="Ano" onChange={trataAno} />
            <input type="text" name="descricao" id="descricao" placeholder="Descrição" onChange={trataDescricao} />
            <input type="url" name="linkimg" id="linkimg" placeholder="Link da Imagem" onChange={trataImg} />
